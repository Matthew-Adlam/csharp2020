namespace csharp2020
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.PnlGame.Controls.Add(this.easyFButton);
            this.PnlGame.Controls.Add(this.hardFButton);
            this.PnlGame.Controls.Add(this.mediumFButton);
            this.PnlGame.Controls.Add(this.mediumNButton);
            this.PnlGame.Controls.Add(this.hardNButton);
            this.PnlGame.Controls.Add(this.easyNButton);
